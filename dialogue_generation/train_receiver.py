...
RECEIVER_DIR = '/mnt/u14157_ic_nlp_001_files_nfs/nlpdata1/home/sigao/p2bot_ext/receiver'
...
def setup_args():
    ...
    parser.set_defaults(
        ...
        validation_metric='loss,hits@1',
        validation_metric_mode='min,max',
        ...
        tensorboard_tag='exp',
        tensorboard_metrics='loss,hits@1',
        ...
        num_epochs=num_train_epochs,  # total number of epochs
